<?php
    ...
    $result = mysqli_query($conn," SELECT i.incident_number,a.status,a.answer,date,problem,description FROM incident i,answers a WHERE i.incident_number=a.incident_number AND a.employee_id='".$_SESSION['username']."' ORDER BY i.incident_number,a.status,a.answer;");
?>
